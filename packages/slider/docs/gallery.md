...
<div class="ft-slider -hidden -gallery -cover" data-feature="cover-slider">
  <div class="slide">
    <div class="ft-fit-bg">
      <img src="packages/slider/docs/files/test.jpeg" data-feature="fit" alt="test">
    </div>
  </div>
  <div class="slide">
    <div class="ft-fit-bg">
      <img src="packages/slider/docs/files/test2.jpeg" data-feature="fit" alt="test2">
    </div>
  </div>
  <div class="slide">
    <div class="ft-fit-bg">
      <img src="packages/slider/docs/files/test3.jpeg" data-feature="fit" alt="test3">
    </div>
  </div>
  <div class="slide">
    <div class="ft-fit-bg">
      <img src="packages/slider/docs/files/test4.jpeg" data-feature="fit" alt="test4">
    </div>
  </div>
</div>
