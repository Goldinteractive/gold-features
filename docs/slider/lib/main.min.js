(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("feature-slider", ["js-base"], factory);
	else if(typeof exports === 'object')
		exports["feature-slider"] = factory(require("js-base"));
	else
		root["feature-slider"] = factory(root["js-base"]);
 ...
 */
var Slider = function (_features$Feature) {
  _inherits(Slider, _features$Feature);
  ...
  _createClass(Slider, [{
    ...
    value: function init() {
      ...
      window.setTimeout(function () {
        ...
        _this2.flickity.on('select', function () {
          _this2.triggerHub(_this2.node.dataset.sliderIdentifier + ':selected', _this2.flickity);
        });
    ...
    key: '_selectListener',
    value: function _selectListener() {
      var _this3 = this;

      return function (_ref) {
        var label = _ref.label;

        var $slideToSelect = _this3._getBySliderLabel(label);
        var $slides = _this3.node.querySelectorAll('.slide');
        var indexOfSelectedSlide = Array.from($slides).indexOf($slideToSelect);
        _this3.flickity.select(indexOfSelectedSlide);
      };
    }
  }, {
    key: '_getBySliderLabel',
    value: function _getBySliderLabel(label) {
      var $slide = this.$('[data-slider-label=' + label + ']');
      if (!$slide) {
