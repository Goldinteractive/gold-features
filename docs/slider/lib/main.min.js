...
console.log(_flickity2.default.PrevNextButton);

var oldEnable = _flickity2.default.PrevNextButton.prototype.enable;
_flickity2.default.PrevNextButton.prototype.enable = function () {
  console.log('enable');
  oldEnable.call(this);
};

var oldDisable = _flickity2.default.PrevNextButton.prototype.disable;
_flickity2.default.PrevNextButton.prototype.disable = function () {
  console.log('disable');
...
Slider.defaultOptions = {
  ...
  // in case there is no scroll available hide 
  hideNavElementsWhenNotUsable: false,
  listeners: []
};
