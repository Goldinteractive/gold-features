    ...
    value: function init() {
      ...
      if (this.node.nodeName.toLowerCase() == 'video') {
        ...
        var unregisterAndHide = function unregisterAndHide() {
          ...
          _this2.removeEventListener(_this2.node, 'loadeddata', _onload);
          _this2.removeEventListener(_this2.node, 'loadedmetadata', _onload);
        };
        ...
        if (this.node.readyState >= this.node.HAVE_CURRENT_DATA || !this.options.waitForMediaLoaded) {
          ...
          this.addEventListener(this.node, 'loadeddata', _onload);
          this.addEventListener(this.node, 'loadedmetadata', _onload);
        }
      } else {
        ...
        if (this.node.naturalWidth || !this.options.waitForMediaLoaded) {
          ...
          var _onload2 = function _onload2() {
            _this2.removeEventListener(_this2.node, 'load', _onload2);
            _this2._removeInitialHide();
          };

          this.addEventListener(this.node, 'load', _onload2);
        }
      }
    }
  }, {
