(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("feature-page-transition", ["js-base"], factory);
	else if(typeof exports === 'object')
		exports["feature-page-transition"] = factory(require("js-base"));
	else
		root["feature-page-transition"] = factory(root["js-base"]);
...
var _barba = __webpack_require__(0);
 ...
 */
var PageTransition = function (_features$Feature) {
  _inherits(PageTransition, _features$Feature);

  function PageTransition() {
    _classCallCheck(this, PageTransition);

    return _possibleConstructorReturn(this, (PageTransition.__proto__ || Object.getPrototypeOf(PageTransition)).apply(this, arguments));
  }
  ...
  _createClass(PageTransition, [{
    ...
    value: function init() {
      ...
      _barba2.default.Pjax.Dom.wrapperId = this.options.wrapperId;
      _barba2.default.Pjax.Dom.containerClass = this.options.containerClass;
      var preventCheck = _barba2.default.Pjax.preventCheck;
      ...
      _barba2.default.Pjax.preventCheck = function (evt, element) {
        return preventCheck.call(this, evt, element) && hasClass(element, self.options.transitionClass);
      };
      ...
      _barba2.default.Dispatcher.on('newPageReady', function (currentStatus, prevStatus, htmlElementContainer, newPageRawHTML) {
        _jsBase.features.init(htmlElementContainer);
      });
      _barba2.default.Pjax.getTransition = this.options.getTransition;
      ...
      _barba2.default.Dispatcher.on('initStateChange', function (currentStatus) {
        _jsBase.features.destroy(_this2.node, undefined, { justChildNodes: true });
      });
...
var _fade = __webpack_require__(4);

var _fade2 = _interopRequireDefault(_fade);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.FadeTransition = _fade2.default;
...
exports.default = _barba2.default.BaseTransition.extend({
