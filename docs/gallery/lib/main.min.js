(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("feature-gallery", ["js-base"], factory);
	else if(typeof exports === 'object')
		exports["feature-gallery"] = factory(require("js-base"));
	else
		root["feature-gallery"] = factory(root["js-base"]);
...
var SELECTOR_PSWP = '[data-pswp]';
var SELECTOR_FIGURE = '[data-figure]';
var SELECTOR_SOURCE = '[data-source]';
var SELECTOR_WIDTH = '[data-width]';
var SELECTOR_HEIGHT = '[data-height]';
...
var Gallery = function (_features$Feature) {
  _inherits(Gallery, _features$Feature);
  ...
  _createClass(Gallery, [{
    ...
    value: function open(index) {
      var disableAnimation = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      this.photoSwipe = new _photoswipe2.default(this.$pswpElement, _photoswipeUiDefault2.default, this.items, options);
      this.photoSwipe.init();
    }
  }, {
    key: '_parseFigures',
    value: function _parseFigures() {
      var _this2 = this;
      ...
      this.$$figures.forEach(function ($figure, index) {
        var $source = _jsBase.utils.dom.$(SELECTOR_SOURCE, $figure);
        var $width = _jsBase.utils.dom.$(SELECTOR_WIDTH, $figure);
        var $height = _jsBase.utils.dom.$(SELECTOR_HEIGHT, $figure);
        var $thumbnail = _jsBase.utils.dom.$(SELECTOR_THUMBNAIL, $figure);
        var $caption = _jsBase.utils.dom.$(SELECTOR_CAPTION, $figure);
        ...
        var item = {
          ...
          elements: {
            $source: $source, $width: $width, $height: $height, $thumbnail: $thumbnail, $caption: $caption
          }
        };
    ...
    value: function _openByHash() {
      var hash = _jsBase.utils.url.hash();

      if (hash) {
        var data = _jsBase.utils.url.parseQuery(hash);
    ...
    key: '_initPswpElement',
    value: function _initPswpElement() {
      this.$pswpElement = _jsBase.utils.dom.$(SELECTOR_PSWP);
    ...
    key: '_clickThumbnailListener',
    value: function _clickThumbnailListener() {
      var _this3 = this;

      return function (e) {
        e.preventDefault();
        var $clickedListItem = e.target.closest(SELECTOR_FIGURE);
...
Gallery.defaultOptions = {
  ...
  getThumbBoundsFn: function getThumbBoundsFn(index) {
    ...
    return {
      x: rect.left,
      y: rect.top + _jsBase.utils.dom.scrollY(),
      w: rect.width
    };
  },
  shareButtons: [{ id: 'facebook', label: 'Teile auf Facebook', url: 'https://www.facebook.com/sharer/sharer.php?u={{url}}' }, { id: 'twitter', label: 'Teile auf Twitter', url: 'https://twitter.com/intent/tweet?text={{text}}&url={{url}}' }, { id: 'google', label: 'Teile auf Google', url: 'https://plus.google.com/share?url={{url}}' }, { id: 'download', label: 'Download', url: '{{raw_image_url}}', download: true }]
};
